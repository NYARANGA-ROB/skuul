...
<<<<<<< HEAD
                ...
                Route::prefix('fees/fee-invoices/{fee_invoice}')->group(function () {
                    // Show M-Pesa payment form
                    Route::get('/mpesa', 'App\Http\Controllers\PaymentController@showMpesaForm')
                        ->name('fee-invoices.mpesa-payment')
                        ->middleware('can:processMpesa,App\Models\FeeInvoice');
                    
                    // Handle M-Pesa payment callback (webhook)
                    Route::post('/mpesa/callback', 'App\Http\Controllers\PaymentController@handleMpesaCallback')
                        ->name('fee-invoices.mpesa-callback');
                    
                    // Check M-Pesa payment status
                    Route::get('/mpesa/status/{checkoutRequestId}', 'App\Http\Controllers\PaymentController@checkPaymentStatus')
                        ->name('fee-invoices.mpesa-status');
                });
                
                // Receipt download route
                Route::get('/payments/receipt/{payment}', 'App\Http\Controllers\PaymentController@getReceipt')
